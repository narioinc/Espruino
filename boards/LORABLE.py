...
info = {
 ...
 'bootloader' : 1,
 'binary_name' : 'espruino_%v_lora.hex',
 'build' : {
   'optimizeflags' : '-Os',
   'libraries' : [
     'BLUETOOTH'
   ...
   'makefile' : [
     ...
     'DEFINES+=-DBLUETOOTH_NAME_PREFIX=\'"LoraB"\'',
     'DFU_PRIVATE_KEY=targets/nrf5x_dfu/dfu_private_key.pem',
     'DFU_SETTINGS=--application-version 0xff --hw-version 52 --sd-req 0x8C',
     'INCLUDE += -I$(ROOT)/libs/lorab -I$(ROOT)/libs/lorab/boards/RAK8211 -I$(ROOT)/libs/lorab/radio -I$(ROOT)/libs/lorab/mac -I$(ROOT)/libs/lorab/mac/region',
     'WRAPPERSOURCES += libs/lorab/jswrap_lorab.c'
   ]
 }
};
